...
const Services = () => {
  return (
    <div className='pt-16 pb-16 mt-[50px] ' id='services'>
     ...
     {SerList.map((service)=>(
       <div key={service.id} className='bg-gradient-to-r from-pink-500 via-purple-600 to-purple-600 animate-gradient-xy p-6 rounded-lg hover:scale-105 transition-all duration-300'>
