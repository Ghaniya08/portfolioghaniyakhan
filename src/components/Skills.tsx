  ...
  return (
    <div className='mt-[100px] mb-[100px]' id='skills'>
      ...
      <div className='mt-20  w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-center'>
        {SkillList.map((skill) => (
          <div key={skill.id} className='p-6 duration-300 from-purple-700 bg-gradient-to-tr to-pink-500 transition-all cursor-pointer text-center rounded-lg bg-gray-100'>
